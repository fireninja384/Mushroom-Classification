# -*- coding: utf-8 -*-
"""Copy of Mushroom_Data_Preprocessing_Project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11cPV3dR0kygUFQOxIgFMpIdB6Xxk2o3J
"""
...
orig_categorical_cols = X_train.select_dtypes(exclude=np.number).columns.tolist() # TODO: Extract the categorical columns from the training data set and store it as a list
...
X_train_enc = pd.get_dummies(X_train_enc, columns=remaining_cat_cols, drop_first=False)
X_test_enc = pd.get_dummies(X_test_enc, columns=remaining_cat_cols, drop_first=False)
